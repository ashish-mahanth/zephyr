...
if(CONFIG_SOC_FAMILY MATCHES "microchip" OR CONFIG_SOC_FAMILY MATCHES "atmel")
  if(DEFINED CONFIG_SOC AND CONFIG_SOC)
    ...
    list(APPEND TOOLCHAIN_LD_FLAGS "-mprocessor=${XC32_PROCESSOR}")
  endif()
  ...
  list(APPEND TOOLCHAIN_LD_FLAGS "-mdfp=${mdfp}")
endif()

list(APPEND TOOLCHAIN_GROUPED_LD_FLAGS TOOLCHAIN_LD_FLAGS)
